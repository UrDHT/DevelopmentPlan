...
Chord can be implemented using a fairly straightforward distance function.
...
Now that we have a \texttt{distance} function, DGVH can generate a Delaunay Triangulation for the space.
