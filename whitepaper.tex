...
Another ambiguous issue with DHTs and DHT-based P2P applications we encountered is what we have termed the \textit{bootstrapping problem}.
A node can only join the network if it knows another node that is already a member of the network it is trying to join.
