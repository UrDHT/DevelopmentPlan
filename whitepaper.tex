...
The resulting short peers are a subset of the nodes Delaunay neighbors/
A crucial feature is that this subset guarantees  
...
%TODO SIZEs of short peers and long peers expected sizes
%TODO Algorithm complexity
%TODO How do we hanlde long peers
...
\label{sec:urdht}
	...
	Most of our discussion will focus on the Logic component, but 
	...
	and network dictates the protocol for how nodes communicate.
