...
\begin{itemize}
	...
	While there has long existed a well known API for distributed hash tables, these define what a DHT needs to be able to do.
	It does not describe what a DHT is.
	We define a set of simple functions that are needed to implement a DHT.
	We show that using these functions, DHTs cleanly map to Delaunay triangulations and Voronoi tessellations (Section \ref{sec:define}).
