...
We discovered that all DHTs can cleanly map to the primal-dual problems of Voronoi Tessellation and 
...
This motivated us to create a means of latency into the DHT
, while still maintaining the system's fault tolerance.
Doing so would allow mean that the hops traversed to a destination are, in fact, the shortest path to the destination.
