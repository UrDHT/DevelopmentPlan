...
The ranking function is similar to the metrics used by UrDHT using DGVH, but DGVH guarantees full connectivity in all cases.

UrDHT uses gossiping because it works.
