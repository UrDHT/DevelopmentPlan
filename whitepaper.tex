...
We created 500 node networks, starting with a single node and adding a node each maintence cycle.\footnote{We varied the amount of maintenance cycles between joins in our experiments, but found it had no effect upon our results.}
...
\caption{This is the average and maximum degree of nodes in the network.}
