...
Our results show that Chord and Kademlia show results which correspond that are expected from previous experiments \cite{chord} \cite{kademlia}.
...
Chord and Kademlia fill this bound asymptotically, whereas the long peer strategy used by the Euclidean and Hyperbolic metrics aggressively filled to this capacity, relying on the distribution of long peers to change as the network increased in size.
